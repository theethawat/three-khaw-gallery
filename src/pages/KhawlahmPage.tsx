...
const KhawlahmPage = () => {
  ...
  const traits = [
    "แมววัวตัวใหญ่ที่มีลวดลายสวยงาม",
    "ชอบเลียเป็นชีวิตจิตใจ แสดงความรักด้วยการเลีย",
    "มีนิสัยขี้อ้อนและชอบความสนใจ",
    "เป็นแมวที่มีความอ่อนโยนและใจดี",
    "ชอบเล่นและวิ่งไล่ของเล่น"
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-orange-50 to-yellow-50">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-orange-700 max-w-2xl mx-auto">
              แมววัวตัวใหญ่ ที่ชอบเลียเป็นชีวิตจิตใจ และเต็มไปด้วยความรักที่จริงใจ
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="bg-white rounded-3xl p-8 shadow-lg mb-12 max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-orange-800 mb-6">เกี่ยวกับข้าวหลาม</h2>
